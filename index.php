...
<body class="alert-info text-dark">
  ...
  <div class="row">
    <div class="card col-md-12 mt-5 mr-2">
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="" class="control-label">Label Tulisan</label>
          <input type="text" id="label" class="form-control">
        </div>
        <div class="form-group">
          <label for="" class="control-label">Tipe Barcode</label>
        ...
        <button type="button" class="col-md-12 btn-block float-right btn btn-primary btn-sm" id="generate">Generate Barcode</button>
      </div>
    </div>
    <div class="card col md-12 md-5 mt-5" id='bcode-card'>
      <div class="card-body">
        <div id="display">
          <center>Barcode Akan Muncul disini setelah berhasil digenerate</center>
        </div>

      </div>
      <div class="card-footer" style="display:none">
        <center>
          <button type="button" class=" btn-block btn btn-success btn-sm" id="print">Cetak Barcode</button>
          <button type="button" class=" btn-block btn btn-primary btn-sm" id="save">Unduh Barcode</button>
        </center>
